...
export default function Setting() {
  ...
  return (
    <div className="flex justify-center items-center flex-col gap-4">
      ...
      {localAdd && <QRCodeSVG className="rounded-md" value={localAdd} size={200} />}
      <a
        target="__blank"
        href={localAdd}
        className="bg-primary-500 px-4 py-2 rounded-2xl tracking-wider underline underline-offset-4 text-white font-semibold"
      >
        {localAdd}
      </a>
    </div>
